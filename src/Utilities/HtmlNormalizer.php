 ...
 *
 * The purpose of this class is to work around an issue where masterminds/html5 treats input HTML as a document
 * fragment rather than a complete document (even if it has a DOCTYPE). DOMDocument automatically adds missing
 * root elements but we cannot pass input through DOMDocument first as it does not have HTML5 support.
 *
